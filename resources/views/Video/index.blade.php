        ...
        <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-blue">
                ...
                <h5 class="widget-user-desc">{{$data['user']->introduce}}
                    <button style="float: right" type="button" class="btn btn-default btn-xs">关注我</button>
                </h5>
            ...
            <div class="inform">
                <div class="box-footer no-padding">
                    <ul class="nav nav-stacked">
                        <li><a href="#">&nbsp;<span class="pull-right"><i class="fa fa-download"></i></span>&nbsp;</a>
                        </li>
    ...
    <div id="app">
        ...
        <div class="box-footer">
            <form action="#" method="post">
                <img class="img-responsive img-circle img-sm" src="{{url("picture/upload/".$data['user']->photo)}}" alt="Alt Text">
                <!-- .img-push is used to add margin to elements next to floating images -->
                <div class="img-push">
                    <input v-model="input" @keyup.13="sub" type="text" class="form-control input-sm" placeholder="Press enter to post comment">
                </div>
            </form>
        </div>
    </div>
